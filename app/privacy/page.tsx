    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-12 lg:px-8">
      ...
      <div>
        <p className="mb-4">
          ...
          information when you use our website. Please take a moment to read
          through this document to understand our practices.
        </p>
        ...
        <ul className="list-inside list-disc space-y-4">
          <li>
            Information you provide: When you sign up for our newsletter, we may
