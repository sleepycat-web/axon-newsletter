...
export default function TracingBeamDemo() {
  return (
    <div>
          ...
          <div className="max-w-2xl mx-auto antialiased px-6 pt-4 relative">
            <div className="mb-10">
              ...
              <div className="text-sm prose-sm prose-invert space-y-2.5">
                ...
                <p>
                  It can dynamically create customized user interfaces in
                  real-time based on the prompts you provide. Whether you need
                  components or a full website, it can deliver in HTML or React,
                  depending on your preference.
                </p>
                <p>
                  And honestly, the results are quite good, with some minor
                  tweaks they can definitely be used in production.
                </p>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="text-sm prose-sm prose-invert space-y-2.5">
                <p>
                  Well, this shift will drive a focus on outcome-oriented
                  design, where designers prioritize user goals and set
                  constraints for AI to work within, instead of designing
                  individual interface elements.
                </p>
                <p>
                  Outcome-oriented design emphasises aligning the user
                  experience with a strong focus on user goals and end results,
                  while strategically automating elements of interaction and
                  interface design.
                </p>
                <p>
                  Go to{" "}
      ...
      {/* Only on Mobile */}
      <div className="bg-neutral-950 block md:hidden font-poppins ">
        <div className="navbar w-full ">
          <Link href="/" className="btn btn-ghost text-lg">
            <FontAwesomeIcon icon={faArrowLeft} />
          </Link>
