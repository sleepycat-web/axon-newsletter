        ...
        <div className="mb-10">
          ...
          <div className="text-sm prose-sm prose-invert space-y-4">
            ...
            <Image
              ...
              alt="v0 generating a landing page hero section from a text prompt"
              height="1000"
              width="1000"
              className="rounded-lg mb-5 object-cover"
            />
            <Image
              ...
              alt="Website section with a call to action and footer generated by v0"
              height="1000"
              width="1000"
              className="rounded-lg object-cover"
            />
            <h2 className={twMerge("text-xl mb-4")}>
